...
strilky=u'\U0001F53B'
books=u'\U0001F4DC'
bot = telebot.TeleBot ('1190768561:AAGsGo_scoAfgLrZ_iEJl7gtXwugoVgniTg')
...
def callback_inline(call):
    ...
    if call.message:
        if call.data == 'математики і інформатики':
            ...
            f6 = open('Факультети/Математики.txt', 'r')
            ...
            backend(call.message, 'Back4.1')
                ...
                strily(call.message,call.data)
                f6 = open('Університет/Історія.txt', 'r')
                bot.send_message(chat_id=call.message.chat.id, text=f6.read())
            ...
            strily(call.message,call.data)
            f7 = open('Університет/НауковаБібліотека.txt', 'r')
            bot.send_message(chat_id=call.message.chat.id, text=f7.read())
            ...
            strily(call.message,call.data)
            smile(call.message)
            f8 = open('Студент,Абітурієнт/ДистНавчання.txt', 'r')
            ...
            strily(call.message,call.data)
            f8 = open('Студент,Абітурієнт/ЗапитанняВідповіді.txt', 'r')
            bot.send_message(chat_id=call.message.chat.id, text=f8.read())
            ...
            strily(call.message,call.data)
            f8 = open('Студент,Абітурієнт/КафедраВійськ.txt', 'r')
            bot.send_message(chat_id=call.message.chat.id, text=f8.read())
            viskovaKaf(call.message)
            #backend(call.message,'Back3')
        elif call.data=='Перелік документів':
             strily(call.message,call.data)
             f8 = open('Студент,Абітурієнт/ПерелікДокументів.txt', 'r')
             bot.send_message(chat_id=call.message.chat.id, text=f8.read())
             backend(call.message,'Back4.6')
        elif call.data=='Строки':
             strily(call.message,call.data)
             f8 = open('Студент,Абітурієнт/Строки.txt', 'r')
             bot.send_message(chat_id=call.message.chat.id, text=f8.read())
             backend(call.message,'Back4.6')
            ...
            inozem(call.message)
             ...
             f8 = open('Інститути/ІнституМистецтв.txt', 'r')
             bot.send_message(chat_id=call.message.chat.id, text=f8.read())
